...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-factus-sdk.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-factus-sdk)
...
```bash
php artisan vendor:publish --tag="laravel-factus-sdk-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-factus-sdk-views"
```

## Usage

```php
$factus = new Cotopaco\Factus();
echo $factus->echoPhrase('Hello, Cotopaco!');
```
